...
This recommender system attempts to address the 'cold start problem'  by modeling a user's interests based on recent browsing history. The method uses Doc2Vec to create vector representations of vectors 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODE4MzM2MjU0XX0=
-->