...
Currently, a user's interests are only modeled from past X number of days of browsing history. While a user's most recent interests are important for getting and maintaining 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MzI5MDc3NTZdfQ==
-->